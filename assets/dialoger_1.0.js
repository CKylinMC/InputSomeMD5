...
dialoger.init = function(){
	if(!this.inited){
		(function(document){
			...
			let templetecontent = '';
			templetecontent+= "    <dialog id=\'dialog\' oncancel='dialoger.Triggers.oncancel(event);return false;'>";
...
dialoger.show = function(){
    ...
    this.addClass(document.getElementById('dialog'),'show')
	return this;
}
...
dialoger.close = function(){
    ...
    this.addClass(document.getElementById('dialog'),'hide')
